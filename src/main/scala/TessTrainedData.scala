...
class TessTrainedData(val directory: String, val lang: String, val font: String, val radical_stroke: String, val config: String) {
  ...
  def fullPrepare(textFilePath: String) = {
    prepareStage0(textFilePath)
    prepareStage1()
    prepareStage2()
    CreateTrainedData()
  }
...
object TessTrainedData {
  def Example() = {
    val tess = new TessTrainedData(
      ...
      "/home/tess/tess-data/radical-stroke.txt",
      // source : https://github.com/tesseract-ocr/langdata/tree/master/chi_sim
      "/home/tess/tess-data/chi_sim.config")

    tess.fullPrepare("/home/tess/tess-data/first.txt")
  }
}
